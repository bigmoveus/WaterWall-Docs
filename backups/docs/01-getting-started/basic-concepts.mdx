...
3. **[آموزش عملی](/docs/category/tutorials)** - تونل‌های واقعی راه‌اندازی کنید
4. **[مرجع گره‌ها](/docs/category/node-reference)** - تمام گره‌ها را بشناسید

**تبریک! حالا آماده‌اید برای ساخت تونل‌های قدرتمند** 🚀

_"بهترین راه یادگیری، تمرین است!"_ 💪
